  ...
  render() {
    ...
    return (
      <>
        ...
        <Button color="primary" type="button" onClick={() => this.toggleModal("EditEntryCommentsModal")}>
          Edit
        </Button>
        {/* Modal */}
        <Modal
          className="modal-dialog-centered"
          isOpen={this.state.EditEntryCommentsModal}
          toggle={() => this.toggleModal("EditEntryCommentsModal")}
        >
          <div className="modal-header">
            <h5 className="modal-title" id="EditEntryCommentsModalLabel">
            Edit Entry Comments
            </h5>
            <button
              aria-label="Close"
              ...
              data-dismiss="modal"
              type="button"
              onClick={() => this.toggleModal("EditEntryCommentsModal")}
            >
...
export default connect(null, mapDispatchToProps)(EditEntryCommentsModal);
